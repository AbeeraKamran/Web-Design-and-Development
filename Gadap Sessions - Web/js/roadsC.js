(function() {
  ...
  Kaleidoscope = (function() {
    Kaleidoscope.prototype.HALF_PI = Math.PI / 3;
  ...
  image.src = 'https://s3.amazonaws.com/websiteimagery/roads_3.jpg';
  ...
  kaleidoscope.domElement.style.left = '60%';

  kaleidoscope.domElement.style.top = '30%';
  ...
  (update = (function(_this) {
    return function() {
      ...
      return setTimeout(update, 1000 / 500);
    };
  })(this))();

  gui = new dat.GUI;

  gui.add(kaleidoscope, 'zoom').min(0.5).max(1.0);

  gui.add(kaleidoscope, 'slices').min(40).max(62).step(2);

  gui.add(kaleidoscope, 'radius').min(100).max(300);
  ...
  gui.add(kaleidoscope, 'offsetScale').min(0.5).max(1.0);
